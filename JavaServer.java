...
public class JavaServer {
    ...
    // private static String buildJsonResponse(int result, long timeTaken, long memoryUsage) {
    ...
    private static HttpHandler createHandler(String endpoint, java.util.function.Function<Integer, String> calculator) {
        return exchange -> {
            ...
            try {
                ...
                System.out.println(endpoint + "(" + number + ") - Time: " + perf.timeTaken + "ms, Memory: " + perf.memoryUsage + " bytes");
            } catch (Exception e) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        server.createContext("/api/factorial", createHandler("factorial", n -> 
            "\"" + factorial(n).toString() + "\""));
        
        server.createContext("/api/fibonacci", createHandler("fibonacci", n -> 
            "\"" + fibonacci(n).toString() + "\""));
        
        server.createContext("/api/primes", createHandler("primes", n -> 
            String.valueOf(countPrimes(n))));
        ...
        server.createContext("/api/json", createHandler("json", n -> 
            jsonOperations(Math.min(n, 1000))));
